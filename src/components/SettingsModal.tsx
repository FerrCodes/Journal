    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50 backdrop-blur-sm animate-fadeIn">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-full sm:max-w-3xl max-h-[85vh] h-[520px] sm:h-[500px] overflow-hidden mx-2 sm:mx-4 animate-scaleIn flex flex-col">
        ...
        <div className="px-6 py-4 border-b border-gray-200 dark:border-slate-700 flex items-center justify-between flex-shrink-0">
          <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 flex items-center gap-2"><SettingsIcon className="w-6 h-6 text-blue-500" />{t('settings.title')}</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-1 overflow-hidden flex-col sm:flex-row">
          ...
          <div className="hidden sm:flex sm:w-48 flex-shrink-0 border-r border-gray-200 dark:border-slate-700 overflow-y-auto p-2 flex-col gap-1">
            {menuItems.map((item) => (
              ...
              >
                ...
                <span className="font-medium">{t(`settings.tabs.${item.id}`)}</span>
              </button>
            ))}
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-6">
            ...
            {activeTab === 'theme' && (
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">{t('settings.theme')}</h3>
                <div className="space-y-3">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-700 dark:text-gray-300">{t('settings.light')}</span>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-700 dark:text-gray-300">{t('settings.dark')}</span>
                    </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <span>{isDeleting ? t('common.saving') : t('settings.deleteAllJournals')}</span>
                  </button>
                  <p className="text-xs text-red-500 dark:text-red-400">{t('settings.deleteWarning')}</p>
                </div>
              </div>
            )}
            ...
            {activeTab === 'about' && (
              <div>
                ...
                <div className="space-y-3 text-gray-700 dark:text-gray-300">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">{t('settings.createdBy')} Feri</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">{t('settings.version')}: <span className="font-mono">1.5.0</span></p>
                </div>
              </div>
            )}
          </div>
